...
de dire comment le modèles prédit exactement les données. C'est pourquoi la
...
proche du coin haut gauche de la courbe ROC. On remarque que le modèle de boosting de gradient stochastique
prédit mieux les vrais renouvellements et moins de faux renouvellement que le
...
Premièrement, comme discuté
précédemment, chaque matrice de confusion offre des avantages et des désavantages,
mais les avantages sont meilleurs pour le gbm. Par exemple, on augmente de 192
les vrais renouvellements pour seulement augmenter de 29 les faux renouvellements.

Deuxièmement, prenons le cas ou la prédiction servirait à optimiser la stratégie
de renouvellement des assurés, par exemple en augmentant plus les assurées avec
une faible probabilité de résignation. Dans ce cas, le fait de prédire de faux
renouvellement n'a aucun effet puisque peu importe l'augmentation, l'assuré
aurait résigné; conséquemment, ceci n'a pas d'impact sur la rentabilité.  Ainsi,
la matrice de confusion qui maximise les vrais renouvellements au coût de prédire
plus de faux renouvellement est le modèle gbm.

Finalement, bien que le modèle final soit le gradient boosting, les résultats
auraient pu être meilleurs. En effet, beaucoup de faux renouvellements sont 
générés ce qui pourrait avoir des effets sur la rentabilité de la compagnie
puisqu'elle aurait pu charger plus cher à ces assurés. Le modèle pourrait être
...
la fréquence d'accident ainsi que le coût de ses accidents aurait permis de mieux 
déterminer pourquoi il y avait une augmentation de la prime. De plus, nous avons
vu que la région avait un impact important. Il aurait été pertinent de savoir
davantage ce qui caractérise ses différentes régions.

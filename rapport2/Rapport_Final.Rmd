...
probabilité de renouvellement des assurés. Pour ce faire, nous avons utilisé un
jeux de données, nommée _eudirectlapse_,  provenant du packetage _CASdataset_
...
variables qui voient leurs coeficients ($\beta$) rétrécir à $0$ sont
...
est pertimant de mentionner que c'est la variable représentant la prime pure
...
probabilité de renouvellement, ce qui est logique puisqu'il est normal que le

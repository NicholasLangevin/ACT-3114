...
autoref{tbl:conf-matrice-modele-final} montre les résultats des prédictions 
sur les données tests en utilisant le seuil optimal qui mène au point le plus
...
glm. En opposition, le glm prédit légérement mieux les vrais résignations
et prédit moins de fausse résignation. En vu des ses tableaux de confusion,
le modèles qui devrait être utilisé par la compagnie d'assurance pour 
prédire les résignations serait le modèle GBM. En plus d'avoir une meilleur
matrice de confusion, il est moins grave de prédire des fausse résignation
puisque si la compagnie utilise ses prédictions pour optimisé leurs statégie de
renouvellement, par exemple en augmentant les clients avec un faible
probabilité, les clients aurais résigné de toutes façon et ses mauvaise prédiction
n'auront aucun impact sur la rentabilité.
